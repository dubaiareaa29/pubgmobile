$(document).ready(function() {
	...
	$('.generate-button').click(function() {       
        if ($('#username-input').val() != '') {
            if ($selected_platform != '') {
				if ($selected_Cash != '' || $selected_Resources != '' || $selected_Keys != '') {
				$('#csr-generator').fadeOut(700, function() {
					$('#csr-generator-console').fadeIn(800, function() {
						...
						setTimeout(function() { $('.console-message-1').fadeIn(); }, 2200 );
						setTimeout(function() { $('.console-message-2').fadeIn(); }, 3000 );
						setTimeout(function() { $('.console-message-3').fadeIn(); }, 3900 );
						setTimeout(function() { $('.console-message-4').fadeIn(); }, 5000 );
						setTimeout(function() { $('.console-message-5').fadeIn(); }, 6000 );
						setTimeout(function() { $('.console-message-6').fadeIn(); }, 6500 );
						setTimeout(function() { $('.console-message-7').fadeIn(); }, 7900 );
						setTimeout(function() { $('.console-message-8').fadeIn(); }, 8800 );
						setTimeout(function() { $('.console-message-9').fadeIn(); }, 11500 );
						setTimeout(function() { $('.console-message-10').fadeIn(); }, 13500 );
						setTimeout(function() { $('.console-message-11').fadeIn(); }, 14500 );
						setTimeout(function() { $('.console-message-12').fadeIn(); }, 15200 );
						setTimeout(function() { $('.console-message-13').fadeIn(); }, 17000 );
						setTimeout(function() { $('.console-message-14').fadeIn(); }, 18000 );
						setTimeout(function() { $('.console-message-15').fadeIn(); }, 20000 );
						setTimeout(function() { $('.console-message-16').fadeIn(); }, 22000 );
						setTimeout(function() { $('.console-messages').fadeOut(); }, 24000 );
						setTimeout(function() { $('.human-verification-wrapper').fadeIn(); }, 24500 );
					});
				});
				} else {
					sweetAlert("Error", "Please select your Coins.", "error");
				}	
            } else {
	...
	$('.crs-Resources-select-item').click(function() {       
        if ($('#username-input').val() != '') {
            if ($selected_platform != '') {
				fixResourcesBox($(this));				
            } else {
                sweetAlert("Error", "Please select your Platform.", "error");
            }
        } else {
	...
	$('.crs-Resourcesen-key-select-item').click(function() {       
        if ($('#username-input').val() != '') {
            if ($selected_platform != '') {
				fixKeysBox($(this));				
            } else {
	...
	function fixResourcesBox($Resources_parent_class) {
        resetResourcesBoxes();
        if ($Resources_parent_class.hasClass('Resources-1')) {
            $selected_Resources = '1000';
        }
        if ($Resources_parent_class.hasClass('Resources-2')) {
            $selected_Resources = '5000';
        }
        if ($Resources_parent_class.hasClass('Resources-3')) {
            $selected_Resources = '50000';
        }
        $Resources_parent_class.addClass('active');
    }
	
    function resetResourcesBoxes() {
        var $Resources_list = $('.Resources-1, .Resources-2, .Resources-3');	
        if ($Resources_list.hasClass('active')) {
...
$(document).ready(function() {
    ...
    $('#X00ButtonChat')['click'](function() {
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  lol stop wasting ur time and take your free Pokemon Go Coins');

                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit Pokemon Go Coins generator out there');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' he just wants all Pokemon Go Coins for himself haha');
